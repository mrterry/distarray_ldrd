...
To appreciate the significance of this proposal, consider the quantity of data generate
by HYDRA\@.  HYDRA is a massively parallel, 3 dimensional, radiation-hydrodynamics code, 
whose the main application of is the simulation inertial confinement fusion
experiments on the National Ignition Facility.  A large 3D HYDRA simulation can have
	xx grid points, run on 
	xx processors, consume 
	xx TB of RAM and produce 
...
After 50 years of concerted effort, LLNL stands on the verge of demonstrating fusion
ignition and energy gain on the NIF\@.  In this, HYDRA occupies a central role in designing NIF experiments and in interpreting the experimental data gathered.  It is important that 
